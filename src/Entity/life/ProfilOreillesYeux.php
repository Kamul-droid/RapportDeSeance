...
/**
 * @ORM\Entity(repositoryClass=ProfilOreillesYeuxRepository::class)
 */
class ProfilOreillesYeux
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
    ...
    /**
     * @ORM\ManyToOne(targetEntity=FicheClient::class, inversedBy="oreilles_yeux")
     */
    private $ficheClient;
