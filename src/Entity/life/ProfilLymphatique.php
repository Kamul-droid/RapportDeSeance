...
/**
 * @ORM\Entity(repositoryClass=ProfilLymphatiqueRepository::class)
 */
class ProfilLymphatique
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
    ...
    /**
     * @ORM\ManyToOne(targetEntity=FicheClient::class, inversedBy="lymphatique")
     */
    private $ficheClient;
