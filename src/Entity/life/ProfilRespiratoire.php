...
/**
 * @ORM\Entity(repositoryClass=ProfilRespiratoireRepository::class)
 */
class ProfilRespiratoire
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
    ...
    /**
     * @ORM\ManyToOne(targetEntity=FicheClient::class, inversedBy="respiratoire")
     */
    private $ficheClient;
